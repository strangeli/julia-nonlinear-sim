...
begin
	...
	plot(mean(norm_energy_d_I[1],dims=2),legend=:topright, label = L"\kappa = 0\, h^{-1}", ytickfontsize=14,
			   ...
			   legendfontsize=14, linewidth=3,xaxis=("days [c]",font(14)), yaxis = ("2-norm of the error",font(14)), linecolor = :blue, alpha=0.4) #  ylims=(0,1e6)
	plot!(mean(norm_energy_d_I[2],dims=2), label= L"\kappa = 0.1\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :black)
	plot!(mean(norm_energy_d_I[3],dims=2), label= L"\kappa = 0.2\, h^{-1}",  linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_I[4],dims=2),label=  L"\kappa = 0.3\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_I[5],dims=2), label= L"\kappa = 0.4\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
	title!("Error norm for scenario I")
	savefig("$dir/plots/$(date)_kappa_Y6_homo_N_$(N)_I_sign.svg")
	...
	plot(mean(norm_energy_d_I[5],dims=2),legend=:topright, label = L"\kappa = 0.4\, h^{-1}", ytickfontsize=14,
			   ...
			   legendfontsize=13, linewidth=3,xaxis=("days [c]",font(14)), yaxis=("2-norm of the error",font(14)),linecolor = :black)  # ylims=(0,1e6)
	plot!(mean(norm_energy_d_I[6],dims=2),label=  L"\kappa = 0.5\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_I[7],dims=2),label=  L"\kappa = 0.6\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_I[8],dims=2),label=  L"\kappa = 0.7\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
	#plot!(mean(norm_energy_d[9],dims=2), label= L"\kappa = 2 h^{-1}", linewidth = 3, linestyle=:dot)
	title!("Error norm for scenario I")
	savefig("$dir/plots/$(date)_kappa2_Y6_homo_N_$(N)_I_sign.svg")
end
	##############################################################################################
	###############################################################################################
	##############################################################################################
...
begin
	...
	plot(mean(norm_energy_d_II[1],dims=2),legend=:topright, label = L"\kappa = 0\, h^{-1}", ytickfontsize=14,
	           xtickfontsize=14, linestyle=:dot, margin=8Plots.mm, left_margin=15Plots.mm, ylims =(0,9900),
			   legendfontsize=14, linewidth=3,xaxis=("days [c]",font(14)), yaxis = ("2-norm of the error",font(14)), linecolor = :blue, alpha=0.4) #  ylims=(0,1e6)
	plot!(mean(norm_energy_d_II[2],dims=2), label= L"\kappa = 0.1\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :black)
	plot!(mean(norm_energy_d_II[3],dims=2), label= L"\kappa = 0.2\, h^{-1}",  linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_II[4],dims=2),label=  L"\kappa = 0.3\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_II[5],dims=2), label= L"\kappa = 0.4\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
	title!("Error norm for scenario II")
	savefig("$dir/plots/$(date)_kappa_Y6_homo_N_$(N)_II_sign.svg")

	using LaTeXStrings
	plot(mean(norm_energy_d_II[5],dims=2),legend=:topright, label = L"\kappa = 0.4\, h^{-1}", ytickfontsize=14,
	           xtickfontsize=14, linestyle =:solid, margin=8Plots.mm,left_margin=15Plots.mm, ylims =(0,9900),
			   legendfontsize=13, linewidth=3,xaxis=("days [c]",font(14)), yaxis=("2-norm of the error",font(14)),linecolor = :black)  # ylims=(0,1e6)
	plot!(mean(norm_energy_d_II[6],dims=2),label=  L"\kappa = 0.5\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_II[7],dims=2),label=  L"\kappa = 0.6\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
	plot!(mean(norm_energy_d_II[8],dims=2),label=  L"\kappa = 0.7\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
	#plot!(mean(norm_energy_d[9],dims=2), label= L"\kappa = 2 h^{-1}", linewidth = 3, linestyle=:dot)
	title!("Error norm for scenario II")
	savefig("$dir/plots/$(date)_kappa2_Y6_homo_N_$(N)_II_sign.svg")
end
...
begin
	...
	#######################################################
		...
		plot(mean(norm_energy_d_III[1],dims=2),legend=:topright, label = L"\kappa = 0\, h^{-1}", ytickfontsize=14,
		           xtickfontsize=14, linestyle=:dot, margin=8Plots.mm, left_margin=15Plots.mm, ylims =(0,9900),
				   legendfontsize=14, linewidth=3,xaxis=("days [c]",font(14)), yaxis = ("2-norm of the error",font(14)), linecolor = :blue, alpha=0.4) #  ylims=(0,1e6)
		plot!(mean(norm_energy_d_III[2],dims=2), label= L"\kappa = 0.1\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :black)
		plot!(mean(norm_energy_d_III[3],dims=2), label= L"\kappa = 0.2\, h^{-1}",  linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
		plot!(mean(norm_energy_d_III[4],dims=2),label=  L"\kappa = 0.3\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
		plot!(mean(norm_energy_d_III[5],dims=2), label= L"\kappa = 0.4\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
 		title!("Error norm for scenario III")
		savefig("$dir/plots/$(date)_kappa_Y6_homo_N_$(N)_III_sign.svg")

		using LaTeXStrings
		plot(mean(norm_energy_d_III[5],dims=2),legend=:topright, label = L"\kappa = 0.4\, h^{-1}", ytickfontsize=14,
		           xtickfontsize=14, linestyle =:solid, margin=8Plots.mm,left_margin=15Plots.mm, ylims =(0,9900),
				   legendfontsize=13, linewidth=3,xaxis=("days [c]",font(14)), yaxis=("2-norm of the error",font(14)),linecolor = :black)  # ylims=(0,1e6)
		plot!(mean(norm_energy_d_III[6],dims=2),label=  L"\kappa = 0.5\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
		plot!(mean(norm_energy_d_III[7],dims=2),label=  L"\kappa = 0.6\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
		plot!(mean(norm_energy_d_III[8],dims=2),label=  L"\kappa = 0.7\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
		#plot!(mean(norm_energy_d[9],dims=2), label= L"\kappa = 2 h^{-1}", linewidth = 3, linestyle=:dot)
		title!("Error norm for scenario III")
		savefig("$dir/plots/$(date)_kappa2_Y6_homo_N_$(N)_III_sign.svg")
end
...
begin
		...
		#######################################################
				...
				plot(mean(norm_energy_d_IV[1],dims=2),legend=:topright, label = L"\kappa = 0\, h^{-1}", ytickfontsize=14,
				           xtickfontsize=14, linestyle=:dot, margin=8Plots.mm, left_margin=15Plots.mm, ylims =(0,9900),
						   legendfontsize=14, linewidth=3,xaxis=("days [c]",font(14)), yaxis = ("2-norm of the error",font(14)), linecolor = :blue, alpha=0.4) #  ylims=(0,1e6)
				plot!(mean(norm_energy_d_IV[2],dims=2), label= L"\kappa = 0.1\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :black)
				plot!(mean(norm_energy_d_IV[3],dims=2), label= L"\kappa = 0.2\, h^{-1}",  linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
				plot!(mean(norm_energy_d_IV[4],dims=2),label=  L"\kappa = 0.3\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
				plot!(mean(norm_energy_d_IV[5],dims=2), label= L"\kappa = 0.4\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
				title!("Error norm for scenario IV")
				savefig("$dir/plots/$(date)_kappa_Y6_homo_N_$(N)_IV_sign.svg")

				using LaTeXStrings
				plot(mean(norm_energy_d_IV[5],dims=2),legend=:topright, label = L"\kappa = 0.4\, h^{-1}", ytickfontsize=14,
				           xtickfontsize=14, linestyle =:solid, margin=8Plots.mm,left_margin=15Plots.mm, ylims =(0,9900),
						   legendfontsize=13, linewidth=3,xaxis=("days [c]",font(14)), yaxis=("2-norm of the error",font(14)),linecolor = :black)  # ylims=(0,1e6)
				plot!(mean(norm_energy_d_IV[6],dims=2),label=  L"\kappa = 0.5\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :blue, alpha=0.4)
				plot!(mean(norm_energy_d_IV[7],dims=2),label=  L"\kappa = 0.6\, h^{-1}", linewidth = 3, linestyle=:solid, linecolor = :blue, alpha=0.4)
				plot!(mean(norm_energy_d_IV[8],dims=2),label=  L"\kappa = 0.7\, h^{-1}", linewidth = 3, linestyle=:dash, linecolor = :black)
		#plot!(mean(norm_energy_d[9],dims=2), label= L"\kappa = 2 h^{-1}", linewidth = 3, linestyle=:dot)
				title!("Error norm for scenario IV")
				savefig("$dir/plots/$(date)_kappa2_Y6_homo_N_$(N)_IV_sign.svg")
end
